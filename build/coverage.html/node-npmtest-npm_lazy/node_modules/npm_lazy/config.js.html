...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-npm_lazy/node_modules/npm_lazy/config.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-npm_lazy/node_modules/npm_lazy/config.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-npm_lazy/node_modules/npm_lazy/</a> &#187; config.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var path = require('path'),
    homePath = path.normalize(process.env[(process.platform == 'win32') ? <span class="branch-0 cbranch-no" title="branch not covered" >'USERPROFILE' </span>: 'HOME']);
&nbsp;
module.exports = {
  // Logging config
  loggingOpts: {
